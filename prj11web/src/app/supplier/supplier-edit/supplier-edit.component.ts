  ...
  initForm(id: string){
    ...
    this.f = new FormGroup({
        ...
        'address': new FormGroup({
          ...
          'uf': new FormControl(address.uf, Validators.required),  
          'localidade': new FormControl(address.uf, Validators.required),  
          'bairro': new FormControl(address.bairro, Validators.required),
          'logradouro': new FormControl(address.logradouro, Validators.required),
